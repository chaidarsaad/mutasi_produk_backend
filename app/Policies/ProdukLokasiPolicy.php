...
class ProdukLokasiPolicy
{
    ...
    {
        return $user->can('view_any_produk::lokasi');
    }
    ...
    {
        return $user->can('view_produk::lokasi');
    }
    ...
    {
        return $user->can('create_produk::lokasi');
    }
    ...
    {
        return $user->can('update_produk::lokasi');
    }
    ...
    {
        return $user->can('delete_produk::lokasi');
    }
    ...
    {
        return $user->can('delete_any_produk::lokasi');
    }
     ...
     */
    public function replicate(User $user, ProdukLokasi $produkLokasi): bool
    {
